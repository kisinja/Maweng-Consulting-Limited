    ...
    return (
        <section className="py-[50px] px-[5%]" id="contact">
            <div className="flex flex-col lg:flex-row justify-between gap-10 lg:gap-0">
                <div className="lg:w-[550px] flex flex-col gap-5">
                    <h5 className="text-sm tracking-wider text-[#62ff00] font-bold">OUR LOCATION</h5>
                    <h1 className="font-bold tracking-wider text-2xl lg:text-5xl">Let Us Do The Work, So You Can Focus On What Matters</h1>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-5">
                        <div className="w-full sm:w-[330px] py-2 px-3 bg-black rounded-md flex gap-4 items-center">
                        ...
                        <div className="w-full sm:w-1/2 py-2 px-3 bg-[#62ff00] rounded-md flex gap-4 items-center">
                    ...
                    <div className="w-full h-[200px] sm:h-[300px] lg:h-[150px]">
